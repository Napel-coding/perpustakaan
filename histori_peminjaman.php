        ...
        <div class="table-container">
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    <?php
                    include "koneksi.php";
                    $qry_histori = mysqli_query($conn, "select * from peminjamanbuku order by id_peminjaman_buku desc");
                    $no = 0;
                    while ($dt_histori = mysqli_fetch_array($qry_histori)) {
                        ...
                        if (mysqli_num_rows($qry_cek_kembali) > 0) {
                            ...
                            // Menyelaraskan warna status "Belum kembali" dengan "Sudah kembali"
